...
import com.example.tema1android.activities.SecondActivity;
...
public class F2A2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button button = view.findViewById(R.id.button_one_a2);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (activityFragmentCommunication != null) {
                    activityFragmentCommunication.replaceF3A2();

                }
            }
        });
        Button button2=view.findViewById(R.id.button_two_a2);
        ...
        Button button3=view.findViewById(R.id.button_three_a2);
